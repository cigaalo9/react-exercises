...
export default function DeveloperForm() {
  ...
  const [formData, setFormData] = useState(() => {
    ...
    const saved = localStorage.getItem("developerForm");
  ...
  useEffect(() => {
    localStorage.setItem("developerForm", JSON.stringify(formData));
  }, [formData]);
  ...
  const handleReset = () => {
    ...
    setErrors({});
    localStorage.removeItem("developerForm");
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex space-x-2">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 rounded-lg bg-rose-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-rose-500 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 disabled:opacity-50"
            >
            ...
            <button
              type="button"
              onClick={handleReset}
              className="flex-1 rounded-lg border border-zinc-300 px-4 py-2 text-sm font-semibold text-zinc-700 hover:bg-zinc-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              Reset
            </button>
          </div>
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30">
            <div className="bg-white rounded-lg p-6 shadow-lg max-w-sm text-center">
              ...
              <button
                ...
                className="rounded-lg bg-rose-600 px-4 py-2 text-white text-sm font-semibold hover:bg-rose-500 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2"
              >
                Close
              </button>
            </div>
